...
func TestLoadConfig(t *testing.T) {
	...
	t.Setenv("YJS_WORKER_URLS", "ws://yjs:8787/internal/realtime/v1")
	...
	t.Setenv("REALTIME_GATEWAY_RATE_LIMIT_RECORD_CACHE_SERVER_START", "9")
	t.Setenv("REALTIME_GATEWAY_RATE_LIMIT_RECORD_CACHE_SERVER_SIZE", "4")
	t.Setenv("REALTIME_GATEWAY_REALTIME_LEASE_CACHE_SERVER_START", "8")
	t.Setenv("REALTIME_GATEWAY_REALTIME_LEASE_CACHE_SERVER_SIZE", "1")
