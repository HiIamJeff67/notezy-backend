...
func (g *WebSocketClient) subscribeResourceEvents() {
...
func (g *WebSocketClient) broadcastResourceEvent(event realtimeleasecache.ResourceEvent) {
...
func (g *WebSocketClient) publishBlockPackPresenceEvent(
	blockPackId uuid.UUID,
...
func (g *WebSocketClient) releaseBlockPackSubscriber(
	blockPackId uuid.UUID,
	member string,
) error {
...
func (g *WebSocketClient) Handle(ctx *gin.Context) {
...
func (g *WebSocketClient) handleBinaryFrame(ctx context.Context, connector *Connector, payload []byte) bool {
...
func (g *WebSocketClient) handleControlFrame(ctx context.Context, connector *Connector, payload []byte) bool {
...
func (g *WebSocketClient) handleChannelBackpressure(
	connector *Connector,
	channel realtimetypes.Channel,
) {
