...
func (ec *executionContext) _SearchBadgeConnection_searchEdges(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.SearchBadgeConnection) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNSearchBadgeEdge2ᚕᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeEdgeᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _SearchBadgeEdge_node(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.SearchBadgeEdge) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPublicBadge2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPublicBadge(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputSearchBadgeFilters(ctx context.Context, obj any) (gqlmodels.SearchBadgeFilters, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "type":
			...
			data, err := ec.unmarshalOBadgeType2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBadgeType(ctx, v)
			if err != nil {
				return it, err
			}
			it.Type = data
...
func (ec *executionContext) unmarshalInputSearchBadgeInput(ctx context.Context, obj any) (gqlmodels.SearchBadgeInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "filters":
			...
			data, err := ec.unmarshalOSearchBadgeFilters2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeFilters(ctx, v)
			if err != nil {
				return it, err
			}
			it.Filters = data
		case "sortBy":
			...
			data, err := ec.unmarshalOSearchBadgeSortBy2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeSortBy(ctx, v)
			if err != nil {
				return it, err
			}
			it.SortBy = data
...
func (ec *executionContext) marshalNSearchBadgeEdge2ᚕᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeEdgeᚄ(ctx context.Context, sel ast.SelectionSet, v []*gqlmodels.SearchBadgeEdge) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSearchBadgeEdge2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeEdge(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNSearchBadgeEdge2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeEdge(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.SearchBadgeEdge) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalOSearchBadgeFilters2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeFilters(ctx context.Context, v any) (*gqlmodels.SearchBadgeFilters, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) unmarshalOSearchBadgeSortBy2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeSortBy(ctx context.Context, v any) (*gqlmodels.SearchBadgeSortBy, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOSearchBadgeSortBy2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchBadgeSortBy(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.SearchBadgeSortBy) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
