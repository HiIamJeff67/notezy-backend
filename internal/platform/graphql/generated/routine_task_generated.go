...
func (ec *executionContext) _PrivateRoutineTask_purpose(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRoutineTask) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose(ctx, field.Selections, res)
}
...
func (ec *executionContext) _PrivateRoutineTask_status(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRoutineTask) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRoutineTaskStatus2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateRoutineTask2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateRoutineTask(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateRoutineTask) graphql.Marshaler {
	if v == nil {
