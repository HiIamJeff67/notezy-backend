...
var sources = []*ast.Source{
	{Name: "../../../../contracts/graphql/schemas/enums/access_control_permission_enum.graphql", Input: `enum AccessControlPermission {
  Owner
  Admin
  Write
  Read
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/badge_type_enum.graphql", Input: `enum BadgeType {
  Diamond
  Golden
  Silver
  Bronze
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/block_type_enum.graphql", Input: `enum BlockType {
	...
	{Name: "../../../../contracts/graphql/schemas/enums/country_code_enum.graphql", Input: `enum CountryCode {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/country_enum.graphql", Input: `enum Country {
  Taiwan
  Japan
  Malaysia
  Singapore
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/item_type_enum.graphql", Input: `enum ItemType {
  ItemType_BlockPack
  ItemType_Material
}
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/language_enum.graphql", Input: `enum Language {
  English
  TraditionalChinese
  SimpleChinese
  Japanese
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/material_content_type_enum.graphql", Input: `enum MaterialContentType {
  None
  Application_JSON
  Application_PDF
  Text_Plain
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/routine_period_enum.graphql", Input: `enum RoutinePeriod {
  RoutinePeriod_Daily
  RoutinePeriod_Weekly
  RoutinePeriod_Monthly
}
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/routine_status_enum.graphql", Input: `enum RoutineStatus {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/routine_task_purpose_enum.graphql", Input: `enum RoutineTaskPurpose {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/routine_task_record_error_code_enum.graphql", Input: `enum RoutineTaskRecordErrorCode {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/routine_task_record_status_enum.graphql", Input: `enum RoutineTaskRecordStatus {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/routine_task_status_enum.graphql", Input: `enum RoutineTaskStatus {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/supported_icon_enum.graphql", Input: `enum SupportedIcon {
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/user_gender_enum.graphql", Input: `enum UserGender {
  Male
  Female
  PreferNotToSay
}
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/user_plan_enum.graphql", Input: `enum UserPlan {
  Enterprise
  Ultimate
  Pro
  Free
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/user_role_enum.graphql", Input: `enum UserRole {
  Admin
  Normal
  Guest
}
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/enums/user_status_enum.graphql", Input: `enum UserStatus {
  Online
  AFK
  DoNotDisturb
  Offline
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/badge.graphql", Input: `type PublicBadge {
  # id: UUID!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/block.graphql", Input: `type PrivateBlock {
    id: UUID!
    blockPackId: UUID!
    parentBlockId: UUID
    prevBlockId: UUID
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/block_pack.graphql", Input: `type PrivateBlockPack {
  id: UUID!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/fields.graphql", Input: `# every schemas or graphql types which want to be searchable
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/item.graphql", Input: `type PrivateItem {
    id: UUID!
    parentSubShelfId: UUID!
    rootShelfId: UUID!
    type: ItemType!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/material.graphql", Input: `type PrivateMaterial {
  id: UUID!
  parentSubShelfId: UUID!
  name: String!
  size: Int64!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/query.graphql", Input: `type Query {
...
# type Subscription {}
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/root_shelf.graphql", Input: `type PrivateRootShelf {
  id: UUID!
  name: String!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/routine.graphql", Input: `type PrivateRoutine {
  id: UUID!
  stationId: UUID!
  title: String!
  description: String!
...
type PrivateSearchableRoutine {
  ...
  itemIds: [UUID!]! 
	...
	{Name: "../../../../contracts/graphql/schemas/routine_tag.graphql", Input: `type PrivateRoutineTag {
  id: UUID!
  name: String!
  color: String!
  icon: SupportedIcon
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/routine_task.graphql", Input: `type PrivateRoutineTask {
  id: UUID!
  routineId: UUID!
  title: String!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/routine_task_record.graphql", Input: `type PrivateRoutineTaskRecord {
  id: UUID!
  routineTaskId: UUID!
  purpose: RoutineTaskPurpose!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/scalar.graphql", Input: `scalar Int32
scalar Int64
scalar UUID
scalar Time
scalar Base64Bytes
...
scalar DatatypeJSON
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_badges.graphql", Input: `# =============== Search Filters & SortBy & SortOrder =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_block.graphql", Input: `# =============== Search SortBy & Input =============== #
...
type SearchBlockConnection implements SearchConnection {
	...
	{Name: "../../../../contracts/graphql/schemas/search_block_packs.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_items.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_materials.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_root_shelves.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_routine_tags.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_routine_task_records.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_routine_tasks.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_routines.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_stations.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_sub_shelves.graphql", Input: `# =============== Search SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_themes.graphql", Input: `# =============== Search Filters & SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/search_users.graphql", Input: `# =============== Search Filters & SortBy & Input =============== #
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/station.graphql", Input: `type PrivateStation {
  id: UUID!
  permission: AccessControlPermission!
  name: String!
  description: String!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/sub_shelf.graphql", Input: `type PrivateSubShelf {
  id: UUID!
  name: String!
  rootShelfId: UUID!
  prevSubShelfId: UUID
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/theme.graphql", Input: `type PublicTheme {
  # id: UUID!
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/user.graphql", Input: `# the complete user structure: internal/services/core/data/schemas/user_schema.go
...
`, BuiltIn: false},
	{Name: "../../../../contracts/graphql/schemas/user_info.graphql", Input: `type PublicUserInfo {
  # id: UUID!
  # userId: UUID!
  avatarURL: String
