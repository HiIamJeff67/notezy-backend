...
func (ec *executionContext) marshalNSearchPageInfo2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchPageInfo(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.SearchPageInfo) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalOSearchSortOrder2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchSortOrder(ctx context.Context, v any) (*gqlmodels.SearchSortOrder, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOSearchSortOrder2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐSearchSortOrder(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.SearchSortOrder) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
