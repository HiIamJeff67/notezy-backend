...
func (ec *executionContext) _PrivateMaterial_contentType(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateMaterial) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMaterialContentType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐMaterialContentType(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateMaterial2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateMaterial(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateMaterial) graphql.Marshaler {
	if v == nil {
