...
func (ec *executionContext) _PrivateBlock_type(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateBlock) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateBlock2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateBlock(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateBlock) graphql.Marshaler {
	if v == nil {
