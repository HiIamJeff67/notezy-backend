...
func (ec *executionContext) _PublicUserInfo_gender(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PublicUserInfo) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUserGender2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐUserGender(ctx, field.Selections, res)
}
...
func (ec *executionContext) _PublicUserInfo_country(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PublicUserInfo) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOCountry2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐCountry(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOPublicUserInfo2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPublicUserInfo(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PublicUserInfo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
