...
func (ec *executionContext) marshalNPrivateSubShelf2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateSubShelf(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateSubShelf) graphql.Marshaler {
	if v == nil {
