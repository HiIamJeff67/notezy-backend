...
func (ec *executionContext) _PublicBadge_type(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PublicBadge) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBadgeType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBadgeType(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPublicBadge2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPublicBadge(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PublicBadge) graphql.Marshaler {
	if v == nil {
