...
func (ec *executionContext) _PrivateRootShelf_sharers(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRootShelf) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*gqlmodels.PublicUser)
	fc.Result = res
	return ec.marshalNPublicUser2ᚕᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPublicUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateRootShelf2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateRootShelf(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateRootShelf) graphql.Marshaler {
	if v == nil {
