...
func (ec *executionContext) _PrivateItem_type(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateItem) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNItemType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐItemType(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateItem2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateItem(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateItem) graphql.Marshaler {
	if v == nil {
