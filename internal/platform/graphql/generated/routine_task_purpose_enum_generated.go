...
func (ec *executionContext) unmarshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose(ctx context.Context, v any) (enums.RoutineTaskPurpose, error) {
	tmp, err := graphql.UnmarshalString(v)
	res := unmarshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose[tmp]
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose(ctx context.Context, sel ast.SelectionSet, v enums.RoutineTaskPurpose) graphql.Marshaler {
	_ = sel
	res := graphql.MarshalString(marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose[v])
	if res == graphql.Null {
...
var (
	unmarshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose = map[string]enums.RoutineTaskPurpose{
	...
	marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐRoutineTaskPurpose = map[enums.RoutineTaskPurpose]string{
