...
func (ec *executionContext) _PrivateSearchableStation_permission(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateSearchableStation) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAccessControlPermission2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐAccessControlPermission(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateSearchableStation2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋplatformᚋgraphqlᚋmodelsᚐPrivateSearchableStation(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateSearchableStation) graphql.Marshaler {
	if v == nil {
