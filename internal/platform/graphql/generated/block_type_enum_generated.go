...
func (ec *executionContext) unmarshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType(ctx context.Context, v any) (enums.BlockType, error) {
	tmp, err := graphql.UnmarshalString(v)
	res := unmarshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType[tmp]
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType(ctx context.Context, sel ast.SelectionSet, v enums.BlockType) graphql.Marshaler {
	_ = sel
	res := graphql.MarshalString(marshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType[v])
	if res == graphql.Null {
...
var (
	unmarshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType = map[string]enums.BlockType{
	...
	marshalNBlockType2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋschemasᚋenumsᚐBlockType = map[enums.BlockType]string{
