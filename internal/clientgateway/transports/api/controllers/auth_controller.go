...
func (c *AuthController) SendAuthCode(ctx *gin.Context, requestDto *apicontract.SendAuthCodeRequestDto) {
	response, exception := coreadapters.Call[apicontract.SendAuthCodeRequestDto, apicontract.SendAuthCodeResponseDto](ctx, c.coreClient, requestDto, apicontract.SendAuthCodeOperation, "/core/v1/auth/email/code")
	if exception != nil {
		exceptionwriter.SafelyAbortAndResponseWithJSON(exception, ctx)
		return
	}
...
func (c *AuthController) ValidateEmail(ctx *gin.Context, requestDto *apicontract.ValidateEmailRequestDto) {
	response, exception := coreadapters.CallSecurly[apicontract.ValidateEmailRequestDto, apicontract.ValidateEmailResponseDto](ctx, c.coreClient, requestDto, apicontract.ValidateEmailOperation, "/core/v1/auth/email/validate")
	if exception != nil {
		exceptionwriter.SafelyAbortAndResponseWithJSON(exception, ctx)
		return
	}
...
func (c *AuthController) ResetEmail(ctx *gin.Context, requestDto *apicontract.ResetEmailRequestDto) {
	response, exception := coreadapters.CallSecurly[apicontract.ResetEmailRequestDto, apicontract.ResetEmailResponseDto](ctx, c.coreClient, requestDto, apicontract.ResetEmailOperation, "/core/v1/auth/email/reset")
	if exception != nil {
		exceptionwriter.SafelyAbortAndResponseWithJSON(exception, ctx)
		return
	}
...
func (c *AuthController) ForgetPassword(ctx *gin.Context, requestDto *apicontract.ForgetPasswordRequestDto) {
	response, exception := coreadapters.Call[apicontract.ForgetPasswordRequestDto, apicontract.ForgetPasswordResponseDto](ctx, c.coreClient, requestDto, apicontract.ForgetPasswordOperation, "/core/v1/auth/password/forget")
	if exception != nil {
		exceptionwriter.SafelyAbortAndResponseWithJSON(exception, ctx)
		return
	}
...
func (c *AuthController) ResetMe(ctx *gin.Context, requestDto *apicontract.ResetMeRequestDto) {
	response, exception := coreadapters.CallSecurly[apicontract.ResetMeRequestDto, apicontract.ResetMeResponseDto](ctx, c.coreClient, requestDto, apicontract.ResetMeOperation, "/core/v1/auth/me/reset")
	if exception != nil {
		exceptionwriter.SafelyAbortAndResponseWithJSON(exception, ctx)
		return
	}
...
func (c *AuthController) DeleteMe(ctx *gin.Context, requestDto *apicontract.DeleteMeRequestDto) {
	response, exception := coreadapters.CallSecurly[apicontract.DeleteMeRequestDto, apicontract.DeleteMeResponseDto](ctx, c.coreClient, requestDto, apicontract.DeleteMeOperation, "/core/v1/auth/me/delete")
	if exception != nil {
		exceptionwriter.SafelyAbortAndResponseWithJSON(exception, ctx)
		return
	}
