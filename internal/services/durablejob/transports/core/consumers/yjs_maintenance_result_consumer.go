...
func (c *YjsMaintenanceResultConsumer) consume(
	...
	if result.Success {
		...
		if exists && result.Operation == durablejobeventscontract.YjsMaintenanceOperation_Compact &&
...
func (c *YjsMaintenanceResultConsumer) retryHint(ctx context.Context, hint durablejobeventscontract.YjsMaintenanceHintData) {
	go func() {
