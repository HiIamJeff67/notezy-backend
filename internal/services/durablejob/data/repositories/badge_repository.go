...
func (r *BadgeRepository) GetOneById(
	...
	if exception := exceptions.Cover(nil, []types.Pair[bool, *exceptions.Exception]{
		{First: result.Error != nil, Second: durablejobexceptions.Badge.NotFound().WithOrigin(result.Error)},
		{First: badge.Id == uuid.Nil, Second: durablejobexceptions.Badge.NotFound()},
	}); exception != nil {
