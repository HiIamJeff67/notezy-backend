...
func (r *RoutineTaskRecordRepository) CheckPermissionAndGetOneById(
	...
	if exception := exceptions.Cover(nil, []types.Pair[bool, *exceptions.Exception]{
		...
		{First: routineTaskRecord.Id == uuid.Nil, Second: durablejobexceptions.RoutineTask.NotFound()},
	}); exception != nil {
...
func (r *RoutineTaskRecordRepository) CheckPermissionsAndGetManyByIds(
	...
	if exception := exceptions.Cover(nil, []types.Pair[bool, *exceptions.Exception]{
		{First: result.Error != nil, Second: durablejobexceptions.RoutineTask.NotFound().WithOrigin(result.Error)},
		{First: len(routineTaskRecords) == 0, Second: durablejobexceptions.RoutineTask.NotFound()},
	}); exception != nil {
		return nil, exception
	}
