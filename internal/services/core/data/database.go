...
import (
	...
	constraints "github.com/HiIamJeff67/notezy-backend/internal/services/core/data/schemas/constraints"
	enums "github.com/HiIamJeff67/notezy-backend/internal/services/core/data/schemas/enums"
	triggers "github.com/HiIamJeff67/notezy-backend/internal/services/core/data/schemas/triggers"
	seeds "github.com/HiIamJeff67/notezy-backend/internal/services/core/data/seeds"
	managementsql "github.com/HiIamJeff67/notezy-backend/internal/services/core/data/sqls/management"
...
func MigrateEnumsToDatabase(db *gorm.DB) bool {
	logs.NotezyLogger.Info(context.Background(), "Migrating enums found in services/core/data/schemas/enums/migrate.go ...")
