...
type OutboxEvent struct {
	...
	AggregateType coreeventscontract.AggregateType `json:"aggregateType" gorm:"column:aggregate_type; type:varchar(64); not null; index:outbox_event_unpublished_index,priority:2;"`
	...
	EventType     coreeventscontract.EventType     `json:"eventType" gorm:"column:event_type; type:varchar(128); not null;"`
	Topic         coreeventscontract.Topic         `json:"topic" gorm:"column:topic; type:varchar(255); not null;"`
