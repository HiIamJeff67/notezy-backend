...
func (ec *executionContext) marshalNPrivateBlockPack2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋappᚋgraphqlᚋmodelsᚐPrivateBlockPack(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateBlockPack) graphql.Marshaler {
	if v == nil {
