...
func (ec *executionContext) marshalNPrivateRoutineTask2ᚕᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋappᚋgraphqlᚋmodelsᚐPrivateRoutineTaskᚄ(ctx context.Context, sel ast.SelectionSet, v []*gqlmodels.PrivateRoutineTask) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPrivateRoutineTask2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋappᚋgraphqlᚋmodelsᚐPrivateRoutineTask(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
