...
type SearchableUserConnection struct {
	Edges      []*SearchableUserEdge `json:"edges"`
	PageInfo   *PageInfo             `json:"pageInfo"`
	TotalCount int32                 `json:"totalCount"`
	SearchTime float64               `json:"searchTime"`
}

func (SearchableUserConnection) IsConnection()               {}
func (this SearchableUserConnection) GetPageInfo() *PageInfo { return this.PageInfo }
...
func (SearchableUserEdge) IsEdge()                {}
func (this SearchableUserEdge) GetCursor() string { return this.Cursor }
