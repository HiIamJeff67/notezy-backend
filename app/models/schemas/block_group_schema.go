...
type BlockGroup struct {
	...
	BlockPackId      uuid.UUID  `json:"blockPackId" gorm:"column:block_pack_id; type:uuid; not null; uniqueIndex:block_group_idx_name_block_pack_id_prev_block_group_id,where:deleted_at IS NULL;"`
	PrevBlockGroupId *uuid.UUID `json:"prevBlockGroupId" gorm:"column:prev_block_group_id; type:uuid; default:null; uniqueIndex:block_group_idx_name_block_pack_id_prev_block_group_id,where:deleted_at IS NULL;"`
