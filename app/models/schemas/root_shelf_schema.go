...
type RootShelf struct {
	...
	OwnerId        uuid.UUID  `json:"ownerId" gorm:"column:owner_id; type:uuid; not null; uniqueIndex:shelf_idx_name_owner_id,where:deleted_at IS NULL;"`
	Name           string     `json:"name" gorm:"column:name; size:128; not null; default:'undefined'; uniqueIndex:shelf_idx_name_owner_id,where:deleted_at IS NULL;"`
