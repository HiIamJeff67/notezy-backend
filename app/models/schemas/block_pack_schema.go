...
type BlockPack struct {
	...
	BlockGroups    []BlockGroup `json:"blockGroups" gorm:"foreignKey:BlockGroupId; reference:Id; constraint:OnUpdate:CASCADE, OnDelete:CASCADE;"`
}

// BlockPack Table Name
func (BlockPack) TableName() string {
	return types.ValidTableName_BlockPackTable.String()
}

// BlockPack Table Relations
type BlockPackRelation types.ValidTableName
