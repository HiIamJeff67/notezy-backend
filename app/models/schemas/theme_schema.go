...
type Theme struct {
	...
	AuthorId      uuid.UUID `json:"authorId" gorm:"column:author_id; type:uuid; not null; index;"`
	Version       string    `json:"version" gorm:"column:version; not null;"`
	IsDefault     bool      `json:"isDefault" gorm:"column:is_default; type: not null;"`
	DownloadURL   string    `json:"downloadURL" gorm:"column:download_url; not null;"`
...
func (Theme) TableName() string {
	return global.ValidTableName_ThemeTable.String()
}
