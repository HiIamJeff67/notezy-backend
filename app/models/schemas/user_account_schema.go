...
type UserAccount struct {
	...
	StationCount        int32              `json:"stationCount" gorm:"column:station_count; type:integer; not null; default:0; check:user_account_check_max_station_count,station_count <= 200;"`
	RoutineCount        int32              `json:"routineCount" gorm:"column:routine_count; type:integer; not null; default:0; check:user_account_check_max_routine_count,routine_count <= 100000;"`
