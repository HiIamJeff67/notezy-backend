...
type Block struct {
	...
	ParentBlockId *uuid.UUID      `json:"parentBlockId" gorm:"column:parent_block_id; type:uuid; check:check_parent_block_id_is_not_itself,parent_block_id != id;"` // unique index of block_idx_root
