...
func (s *OAuthService) GetGoogleUserInfo(
	...
	logs.Info("Client Id: ", s.oauthGoogleConfig.ClientID)
	logs.Info("Client Secret: ", s.oauthGoogleConfig.ClientSecret)
	logs.Info("Redirect URL: ", s.oauthGoogleConfig.RedirectURL)
