# Notegic Commercial End User License Agreement (EULA)
...
- “Software” means the Notegic software, source code, object code, builds, documentation, and any updates provided by Notegic.
...
2. License Grant
   Subject to this EULA, Notegic grants you a limited, non-exclusive, non-transferable, non-sublicensable license to install and use the Software solely for your internal business purposes. No rights are granted except as expressly set forth herein.
...
3. Restrictions
   ...
   (d) use the Software to create, train, or improve a product or service that is the same as or substantially similar to, or that competes with, Notegic’s products or services;
   ...
   (g) merge or integrate the Software into any third-party product without Notegic’s prior written consent.

4. Ownership
   Notegic and its licensors retain all right, title, and interest in and to the Software, including all intellectual property rights. This EULA does not transfer any ownership.
...
6. Trademarks and Branding
   You may not use Notegic’s names, logos, or trademarks, or any confusingly similar marks, without Notegic’s prior written consent. You may make purely descriptive, truthful references (e.g., “compatible with Notegic”) provided you include an appropriate attribution and disclaimer of endorsement.

7. Updates and Support
   Notegic may, but is not obligated to, provide updates, patches, or support. Any updates are governed by this EULA (or a successor version provided with the update).
...
11. Limitation of Liability
    TO THE MAXIMUM EXTENT PERMITTED BY LAW, NOTEGIC SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR FOR LOSS OF PROFITS, REVENUE, DATA, OR GOODWILL. NOTEGIC’S TOTAL AGGREGATE LIABILITY FOR ALL CLAIMS SHALL NOT EXCEED THE FEES PAID BY YOU FOR THE SOFTWARE IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING RISE TO LIABILITY.
...
14. Assignment
    You may not assign or transfer this EULA without Notegic’s prior written consent. Notegic may assign this EULA without restriction.
