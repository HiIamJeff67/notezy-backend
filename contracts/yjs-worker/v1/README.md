...
Commands travel on `notegic.adapters.core.command.v1`; Core replies through its
transactional outbox on `notegic.core.adapters.reply.v1`. Both use the BlockPack
