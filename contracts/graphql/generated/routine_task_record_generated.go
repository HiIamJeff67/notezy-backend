...
func (ec *executionContext) _PrivateRoutineTaskRecord_status(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRoutineTaskRecord) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRoutineTaskRecordStatus2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskRecordStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) _PrivateRoutineTaskRecord_errorCode(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRoutineTaskRecord) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalORoutineTaskRecordErrorCode2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskRecordErrorCode(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateRoutineTaskRecord2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋcontractsᚋgraphqlᚋmodelsᚐPrivateRoutineTaskRecord(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateRoutineTaskRecord) graphql.Marshaler {
	if v == nil {
