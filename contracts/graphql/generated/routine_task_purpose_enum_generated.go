...
func (ec *executionContext) unmarshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose(ctx context.Context, v any) (enums.RoutineTaskPurpose, error) {
	tmp, err := graphql.UnmarshalString(v)
	res := unmarshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose[tmp]
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose(ctx context.Context, sel ast.SelectionSet, v enums.RoutineTaskPurpose) graphql.Marshaler {
	_ = sel
	res := graphql.MarshalString(marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose[v])
	if res == graphql.Null {
...
var (
	unmarshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose = map[string]enums.RoutineTaskPurpose{
	...
	marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose = map[enums.RoutineTaskPurpose]string{
