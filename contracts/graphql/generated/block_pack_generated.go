...
func (ec *executionContext) _PrivateBlockPack_icon(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateBlockPack) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateBlockPack2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋcontractsᚋgraphqlᚋmodelsᚐPrivateBlockPack(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateBlockPack) graphql.Marshaler {
	if v == nil {
