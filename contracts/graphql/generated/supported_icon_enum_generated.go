...
func (ec *executionContext) unmarshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon(ctx context.Context, v any) (*enums.SupportedIcon, error) {
	if v == nil {
		return nil, nil
	}
	tmp, err := graphql.UnmarshalString(v)
	res := unmarshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon[tmp]
	return &res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon(ctx context.Context, sel ast.SelectionSet, v *enums.SupportedIcon) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	_ = sel
	_ = ctx
	res := graphql.MarshalString(marshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon[*v])
	return res
}

var (
	unmarshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon = map[string]enums.SupportedIcon{
	...
	marshalOSupportedIcon2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐSupportedIcon = map[enums.SupportedIcon]string{
