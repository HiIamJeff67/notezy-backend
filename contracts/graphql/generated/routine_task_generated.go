...
func (ec *executionContext) _PrivateRoutineTask_purpose(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRoutineTask) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRoutineTaskPurpose2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskPurpose(ctx, field.Selections, res)
}
...
func (ec *executionContext) _PrivateRoutineTask_status(ctx context.Context, field graphql.CollectedField, obj *gqlmodels.PrivateRoutineTask) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRoutineTaskStatus2githubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋinternalᚋservicesᚋcoreᚋdataᚋdatabaseᚋschemasᚋenumsᚐRoutineTaskStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPrivateRoutineTask2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotezyᚑbackendᚋcontractsᚋgraphqlᚋmodelsᚐPrivateRoutineTask(ctx context.Context, sel ast.SelectionSet, v *gqlmodels.PrivateRoutineTask) graphql.Marshaler {
	if v == nil {
