...
dataloaders belong to `internal/clientgateway/transports/api/graphql/`; they access Core
only through `internal/clientgateway/transports/core/adapters/CoreAdapter`. Each Core
